...
5. **Done editing**.
6. **Save** with a meaningful title and the resource group of our
   workspace.

Required parameters (`Workspace`, `TimeRange`) auto-prompt at the top
of every workbook. `Workspace` lets we point at any LA workspace the
...
The blueprint suggests a few more workbooks that we might want
